...
$(window).bind('scroll resize', function(){
	...
	//當高度小於 45 像素時，移除樣式	
	if($this_Top < 45){
		//$('#navbar').removeClass('topbar_fixed');
		$('#sidebar').removeClass('leftbar_fixed');
		}
	if($this_Top > 45){
		//$('#navbar').addClass('topbar_fixed');
		$('#sidebar').addClass('leftbar_fixed');
		}
	}).scroll();
});