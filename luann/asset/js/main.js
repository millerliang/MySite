...
menu_items += "<section class='menu-section'>";
menu_items += "<label for='items' class='menu-section-title'>";
menu_items += "<i class='fa fa-trophy'></i> 大赛 <small>Dasie</small>";
menu_items += "<i class='fa fa-angle-right'></i>";
menu_items += "</label>";
menu_items += "<input class='sh-state' id='items' type='checkbox' />";
menu_items += "<ul class='menu-section-list sh-modal'>";
menu_items += "<li><a href='dasie-list.html'>大赛作品</a></li>";
menu_items += "<li><a href='dasie-list.html'>我的投票</a></li>";
menu_items += "<li><a href='dasie-form.html'>上传作品</a></li>";
menu_items += "</ul>";
menu_items += "</section>";
menu_items += "<section class='menu-section'>";
